...
local BUTTON_TEXTURES = {
	...
	JOYSTICK = {
		...
		STICK = graphics.newImage("textures/buttons/joystick-ribs.png"),
		FILLED = graphics.newImage("textures/buttons/joystick-ribs-filled.png"),
	},
	CSTICK = {
...
overlay.registerSkin("Classic", SKIN)